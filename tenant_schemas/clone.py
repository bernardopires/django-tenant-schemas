...
# NOTE
#  SQL is coming from https://github.com/denishpatel/pg-clone-schema/ rev ea3fbd7
...
def _create_clone_schema_function():
    ...
    # TODO db_user isn't even actually used in latest sql version of the clone schema. We can probably remove format.
