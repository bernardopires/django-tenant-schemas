...
from tenant_schemas.utils import schema_name_must_be_unique
...
class TenantMixin(models.Model):
    ...
    schema_name = models.CharField(max_length=63, unique=schema_name_must_be_unique(),
        ...
        if is_new and self.auto_create_schema:
            try:
                ...
                if created is False:
                    ...
                    if hasattr(settings, 'SCHEMA_NAME_MUST_BE_UNIQUE') and \
                            settings.SCHEMA_NAME_MUST_BE_UNIQUE is False and \
